export const BUTTON_STYLES = {
  ...
  quietOutline:
    "border-border bg-background text-foreground shadow-xs hover:border-primary/60 hover:bg-primary/8 hover:text-primary hover:shadow-[0_0_0_3px_hsl(var(--primary)/0.12),0_10px_24px_-18px_hsl(var(--primary)/0.45)] focus-visible:ring-4 focus-visible:ring-primary/30",
  quietIcon:
    "h-10 w-10 rounded-md border-border bg-background text-foreground shadow-xs hover:border-primary/60 hover:bg-primary/8 hover:text-primary hover:shadow-[0_0_0_3px_hsl(var(--primary)/0.12),0_10px_24px_-18px_hsl(var(--primary)/0.45)] focus-visible:ring-4 focus-visible:ring-primary/30",
  cardBase:
  ...
  selectorBase:
    "rounded-full border px-3 py-1.5 text-sm font-medium shadow-xs transition-all duration-200 focus:outline-hidden focus-visible:ring-4 focus-visible:ring-ring/30 focus-visible:ring-offset-2",
  selectorActive:
  ...
  disclosure:
    "w-full rounded-md border border-border bg-background px-4 py-3 text-foreground shadow-xs transition-all duration-200 hover:border-primary/60 hover:bg-primary/8 hover:shadow-[0_0_0_3px_hsl(var(--primary)/0.1),0_10px_24px_-20px_hsl(var(--primary)/0.45)] focus:outline-hidden focus-visible:ring-4 focus-visible:ring-primary/30 focus-visible:ring-offset-2",
} as const;
