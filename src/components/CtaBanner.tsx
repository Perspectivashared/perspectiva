  ...
  return (
    <section className="relative py-24">
      <div className="relative z-10 container mx-auto px-4">
        <FadeInView>
          <div className="glass-panel relative mx-auto max-w-3xl overflow-hidden rounded-3xl px-8 py-16 text-center">
            {/* Finale accent — particles resolve around the closing highlight */}
            <HighlightParticles count={20} />
